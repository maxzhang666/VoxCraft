...
# voxcpm 引入的部分 transitive deps（umap-learn / wetext 等）在 linux+py3.12 上
...
# py-build 与 runtime 共用 python:3.12-slim-bookworm，venv shebang 的 /usr/local/bin/python3.12 在两阶段一致
